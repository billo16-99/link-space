...
export function LinkCard({ link, actions, onPress }: LinkCardProps) {
  ...
  function handleLongPress() {
    ...
    Alert.alert(
      ...
      [
        ...actions.map((a) => ({
          text: a.label,
          style: a.danger ? 'destructive' as const : 'default' as const,
          onPress: () => { setMenuOpen(false); a.onPress?.(); },
        })),
        { text: 'Cancel', style: 'cancel' as const, onPress: () => setMenuOpen(false) },
      ]
    );
    setMenuOpen(true);
  }
